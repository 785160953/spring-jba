...
public class JbaBeanPropertyRowMapper<T> implements RowMapper<T> {
     ...
     */
    public JbaBeanPropertyRowMapper(Class<T> mappedClass, boolean checkFullyPopulated) {
        initialize(mappedClass);
    ...
    public static <T> org.springframework.jdbc.core.BeanPropertyRowMapper<T> newInstance(Class<T> mappedClass) {
        return new org.springframework.jdbc.core.BeanPropertyRowMapper<T>(mappedClass);
    }
